...
public class RiotItemData {
    ...
    public static final RiotItemData TheDarkSeal = new RiotItemData("The Dark Seal", "ダークシール", 1082, 350, 350, 245, null, new int[] {3041}, 0, 288, 96, 0, 0, 0.0F, 100, 0, 0, 15, 0, 0, 0, 0, 0);
    ...
    /** Archangel's Staff (Quick Charge) Definition */
    public static final RiotItemData ArchangelsStaffQuickCharge = new RiotItemData("Archangel's Staff (Quick Charge)", "アークエンジェルスタッフ(クイックチャージ)", 3007, 1100, 3100, 2170, new int[] {3073, 1058}, new int[] {3048}, 0, 0, 336, 3, 0, 0.0F, 250, 0, 0, 80, 0, 0, 0, 0, 0);

    /** Manamune (Quick Charge) Definition */
    public static final RiotItemData ManamuneQuickCharge = new RiotItemData("Manamune (Quick Charge)", "マナムネ(クイックチャージ)", 3008, 775, 2400, 1680, new int[] {3073, 1037}, new int[] {3043}, 0, 48, 336, 3, 0, 0.0F, 250, 25, 0, 0, 0, 0, 0, 0, 0);
    ...
    /** Rod of Ages (Quick Charge) Definition */
    public static final RiotItemData RodofAgesQuickCharge = new RiotItemData("Rod of Ages (Quick Charge)", "ロッド・オブ・エイジス(クイックチャージ)", 3029, 750, 2700, 1890, new int[] {3010, 1026}, null, 0, 48, 384, 3, 300, 0.0F, 300, 0, 0, 60, 0, 0, 0, 0, 0);
    ...
    public static final RiotItemData TheBlackCleaver = new RiotItemData("The Black Cleaver", "ブラック・クリーバー", 3071, 750, 3100, 2170, new int[] {3044, 3133}, null, 1, 336, 0, 3, 300, 0.0F, 0, 50, 0, 0, 0, 0, 0, 0, 0);

    /** The Bloodthirster Definition */
    public static final RiotItemData TheBloodthirster = new RiotItemData("The Bloodthirster", "ブラッドサースター", 3072, 1150, 3700, 2590, new int[] {1038, 1036, 1053}, null, 1, 384, 0, 3, 0, 0.0F, 0, 75, 0, 0, 0, 0, 0, 0, 0);

    /** Tear of the Goddess (Quick Charge) Definition */
    public static final RiotItemData TearoftheGoddessQuickCharge = new RiotItemData("Tear of the Goddess (Quick Charge)", "女神の涙(クイックチャージ)", 3073, 275, 750, 525, new int[] {1027, 1004}, new int[] {3007, 3008}, 1, 432, 0, 2, 0, 0.0F, 250, 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    public static final RiotItemData TheHexCoremk1 = new RiotItemData("The Hex Core mk-1", "ヘクスコアMK-1", 3196, 1250, 1250, 875, new int[] {3200}, new int[] {3197}, 1, 288, 336, 2, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** The Hex Core mk-2 Definition */
    public static final RiotItemData TheHexCoremk2 = new RiotItemData("The Hex Core mk-2", "ヘクスコアMK-2", 3197, 1000, 2250, 1575, new int[] {3196}, new int[] {3198}, 1, 336, 336, 3, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    public static final RiotItemData WardingTotemTrinket = new RiotItemData("Warding Totem (Trinket)", "ワードトーテム(トリンケット)", 3340, 0, 0, 0, null, null, 1, 288, 384, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Sweeping Lens (Trinket) Definition */
    public static final RiotItemData SweepingLensTrinket = new RiotItemData("Sweeping Lens (Trinket)", "スイープレンズ（トリンケット）", 3341, 0, 0, 0, null, null, 1, 336, 384, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Greater Stealth Totem (Trinket) Definition */
    public static final RiotItemData GreaterStealthTotemTrinket = new RiotItemData("Greater Stealth Totem (Trinket)", "隠密のトーテム(トリンケット)", 3361, 250, 250, 175, null, null, 1, 0, 432, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Greater Vision Totem (Trinket) Definition */
    public static final RiotItemData GreaterVisionTotemTrinket = new RiotItemData("Greater Vision Totem (Trinket)", "発見のトーテム(トリンケット)", 3362, 250, 250, 175, null, null, 1, 48, 432, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Farsight Alteration Definition */
    public static final RiotItemData FarsightAlteration = new RiotItemData("Farsight Alteration", "ファーサイト・オルタレーション", 3363, 0, 0, 0, null, null, 1, 96, 432, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Oracle Alteration Definition */
    public static final RiotItemData OracleAlteration = new RiotItemData("Oracle Alteration", "オラクル・オルタレーション", 3364, 0, 0, 0, null, null, 1, 144, 432, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    public static final RiotItemData TheBlackSpear = new RiotItemData("The Black Spear", "復讐の黒槍", 3599, 0, 0, 0, null, null, 2, 240, 0, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Seer Stone (Trinket) Definition */
    public static final RiotItemData SeerStoneTrinket = new RiotItemData("Seer Stone (Trinket)", "シアー・ストーン(トリンケット)", 3645, 0, 0, 0, null, null, 2, 432, 144, 0, 0, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Enchantment: Warrior Definition */
    public static final RiotItemData CaulfieldsWarhammerWarrior = new RiotItemData("Caulfield's Warhammer [Warrior]", "エンチャント: ウォリアー", 3671, 525, 1625, 1138, new int[] {3133}, null, 2, 288, 0, 3, 0, 0.0F, 0, 60, 0, 0, 0, 0, 0, 0, 0);

    /** Enchantment: Cinderhulk Definition */
    public static final RiotItemData BamisCinderCinderhulk = new RiotItemData("Bami's Cinder [Cinderhulk]", "エンチャント: シンダーハルク", 3672, 525, 1625, 1138, new int[] {3751}, null, 2, 336, 0, 3, 400, 0.0F, 0, 0, 0, 0, 0, 0, 0, 0, 0);

    /** Enchantment: Runic Echoes Definition */
    public static final RiotItemData AmplifyingTomeRunicEchoes = new RiotItemData("Amplifying Tome [Runic Echoes]", "エンチャント: ルーンエコー", 3673, 340, 1625, 1138, new int[] {3113, 1052}, null, 2, 384, 0, 3, 0, 0.0F, 0, 0, 0, 60, 0, 0, 7, 0, 0);

    /** Enchantment: Bloodrazor Definition */
    public static final RiotItemData RecurveBowBloodrazor = new RiotItemData("Recurve Bow [Bloodrazor]", "エンチャント: ブラッドレイザー", 3675, 625, 1625, 1138, new int[] {1043}, null, 2, 432, 0, 3, 0, 0.0F, 0, 0, 0, 0, 0, 50, 0, 0, 0);
