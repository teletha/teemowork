...
public class RiotChampionData {
    ...
    /** Draven Definition */
    public static final Champion Draven = new Champion(119, "Draven", "ドレイヴン", "Draven", 557.76F, 82.0F, 6.175F, 0.7F, 360.56F, 39.0F, 8.04F, 0.65F, 55.8F, 2.91F, 0.679F, 1.5F, 0.0F, 0.0F, 25.544F, 3.3F, 30.0F, 0.0F, 330.0F, 550.0F, new String[] {"League of Draven", "Spinning Axe", "Blood Rush", "Stand Aside", "Whirling Death"}, new String[] {"リーグ・オブ・ドレイヴン", "回転斬斧", "血の疼き", "薙ぎ払い", "死の車輪"}, SkillDefinition::Draven, false);
    ...
    /** Graves Definition */
    public static final Champion Graves = new Champion(104, "Graves", "グレイヴズ", "Graves", 551.12F, 84.0F, 6.675F, 0.7F, 322.2F, 40.0F, 7.925F, 0.7F, 62.83F, 2.41F, 0.481F, 3.0F, 0.0F, 0.0F, 24.376F, 3.4F, 30.0F, 1.25F, 345.0F, 425.0F, new String[] {"Destiny", "End of the Line", "Smoke Screen", "Quickdraw", "Collateral Damage"}, new String[] {"確固たる信念", "散弾", "煙幕", "早撃ち", "炸裂砲弾"}, SkillDefinition::Graves, false);
