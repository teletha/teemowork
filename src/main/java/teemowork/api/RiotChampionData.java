...
public class RiotChampionData {
    ...
    /** Alistar Definition */
    public static final Champion Alistar = new Champion(12, "Alistar", "アリスター", "Alistar", 613.36F, 106.0F, 8.675F, 0.85F, 278.84F, 38.0F, 6.0F, 0.8F, 61.1116F, 3.62F, 0.625F, 2.125F, 0.0F, 0.0F, 24.38F, 3.5F, 32.1F, 1.25F, 330.0F, 125.0F, new String[] {"Trample", "Pulverize", "Headbutt", "Triumphant Roar", "Unbreakable Will"}, new String[] {"踏破", "圧砕", "頭突き", "戦士の咆哮", "不屈の意志"}, SkillDefinition::Alistar, false);
    ...
    /** Brand Definition */
    public static final Champion Brand = new Champion(63, "Brand", "ブランド", "Brand", 507.68F, 76.0F, 5.42F, 0.55F, 325.6F, 45.0F, 8.005F, 0.6F, 57.04F, 3.0F, 0.625F, 1.36F, 0.0F, 0.0F, 21.88F, 3.5F, 30.0F, 0.0F, 340.0F, 550.0F, new String[] {"Blaze", "Sear", "Pillar of Flame", "Conflagration", "Pyroclasm"}, new String[] {"炎上", "焦炎", "烈火の柱", "焼灼", "業火"}, SkillDefinition::Brand, false);
    ...
    /** Graves Definition */
    public static final Champion Graves = new Champion(104, "Graves", "グレイヴズ", "Graves", 551.12F, 84.0F, 6.675F, 0.7F, 322.2F, 40.0F, 7.925F, 0.7F, 54.208F, 3.1F, 0.625F, 2.9F, 0.0F, 0.0F, 24.376F, 3.2F, 30.0F, 0.0F, 330.0F, 525.0F, new String[] {"True Grit", "Buckshot", "Smoke Screen", "Quickdraw", "Collateral Damage"}, new String[] {"確固たる信念", "散弾", "煙幕", "早撃ち", "炸裂砲弾"}, SkillDefinition::Graves, false);
    ...
    /** Irelia Definition */
    public static final Champion Irelia = new Champion(39, "Irelia", "イレリア", "Irelia", 607.2F, 90.0F, 8.59F, 0.65F, 288.8F, 35.0F, 8.09F, 0.65F, 61.544F, 3.3F, 0.665F, 3.2F, 0.0F, 0.0F, 25.3F, 3.75F, 32.1F, 1.25F, 345.0F, 125.0F, new String[] {"Ionian Fervor", "Bladesurge", "Hiten Style", "Equilibrium Strike", "Transcendent Blades"}, new String[] {"アイオニアの熱情", "瞬剣", "飛天流", "平衡の一撃", "飛剣の舞"}, SkillDefinition::Irelia, false);

    /** Janna Definition */
    public static final Champion Janna = new Champion(40, "Janna", "ジャンナ", "Janna", 487.04F, 78.0F, 5.42F, 0.55F, 409.52F, 64.0F, 9.0F, 0.4F, 51.956F, 2.95F, 0.625F, 2.61F, 0.0F, 0.0F, 19.384F, 3.8F, 30.0F, 0.0F, 335.0F, 475.0F, new String[] {"Tailwind", "Howling Gale", "Zephyr", "Eye Of The Storm", "Monsoon"}, new String[] {"追い風", "大竜巻", "西風の神", "嵐の祝福", "青嵐"}, SkillDefinition::Janna, false);
    ...
    /** Kalista Definition */
    public static final Champion Kalista = new Champion(429, "Kalista", "カリスタ", "Kalista", 517.76F, 83.0F, 6.0F, 0.55F, 231.8F, 35.0F, 6.3F, 0.4F, 57.5F, 3.5F, 0.658F, 3.3F, 0.0F, 0.0F, 19.012F, 3.5F, 30.0F, 0.0F, 325.0F, 550.0F, new String[] {"Martial Poise", "Pierce", "Sentinel", "Rend", "Fate's Call"}, new String[] {"戦いの所作", "貫魂の一投", "執念の霊魂", "引き裂く遺恨", "宿命の呼び声"}, SkillDefinition::Kalista, false);

    /** Karma Definition */
    public static final Champion Karma = new Champion(43, "Karma", "カルマ", "Karma", 522.44F, 83.0F, 5.62F, 0.55F, 374.0F, 50.0F, 6.0F, 0.8F, 53.544F, 3.3F, 0.625F, 2.3F, 0.0F, 0.0F, 20.384F, 3.8F, 30.0F, 0.0F, 335.0F, 525.0F, new String[] {"Gathering Fire", "Inner Flame", "Focused Resolve", "Inspire", "Mantra"}, new String[] {"寄せ火", "内なる炎", "不退転の決意", "激励", "マントラ"}, SkillDefinition::Karma, false);
    ...
    /** Kassadin Definition */
    public static final Champion Kassadin = new Champion(38, "Kassadin", "カサディン", "Kassadin", 564.04F, 78.0F, 7.79F, 0.5F, 347.6F, 70.0F, 6.0F, 0.8F, 58.852F, 3.9F, 0.64F, 3.7F, 0.0F, 0.0F, 23.376F, 3.2F, 30.0F, 0.0F, 340.0F, 150.0F, new String[] {"Void Stone", "Null Sphere", "Nether Blade", "Force Pulse", "Riftwalk"}, new String[] {"ヴォイドの石", "零の魔珠", "冥界の刃", "闇の波動", "無限回廊"}, SkillDefinition::Kassadin, false);
    ...
    /** Lucian Definition */
    public static final Champion Lucian = new Champion(236, "Lucian", "ルシアン", "Lucian", 554.4F, 80.0F, 6.19F, 0.65F, 298.88F, 41.0F, 8.175F, 0.7F, 52.04F, 3.0F, 0.638F, 3.3F, 0.0F, 0.0F, 24.04F, 3.0F, 30.0F, 0.0F, 335.0F, 500.0F, new String[] {"Lightslinger", "Piercing Light", "Ardent Blaze", "Relentless Pursuit", "The Culling"}, new String[] {"二丁掃射", "閃光", "浄化の星印", "瞬脚", "殲滅"}, SkillDefinition::Lucian, false);

    /** Lulu Definition */
    public static final Champion Lulu = new Champion(117, "Lulu", "ルル", "Lulu", 552.76F, 74.0F, 6.005F, 0.6F, 292.4F, 55.0F, 8.5F, 0.6F, 46.368F, 2.6F, 0.625F, 2.25F, 0.0F, 0.0F, 19.216F, 3.7F, 30.0F, 0.0F, 325.0F, 550.0F, new String[] {"Pix, Faerie Companion", "Glitterlance", "Whimsy", "Help, Pix!", "Wild Growth"}, new String[] {"仲良し妖精ピックス", "ぴかぴかランス", "イタズラ", "ピックス、おねがい！", "おおきくなぁれ！"}, SkillDefinition::Lulu, false);

    /** Lux Definition */
    public static final Champion Lux = new Champion(99, "Lux", "ラックス", "Lux", 477.72F, 79.0F, 5.42F, 0.55F, 334.0F, 50.0F, 6.0F, 0.8F, 53.544F, 3.3F, 0.625F, 1.36F, 0.0F, 0.0F, 18.72F, 4.0F, 30.0F, 0.0F, 330.0F, 550.0F, new String[] {"Illumination", "Light Binding", "Prismatic Barrier", "Lucent Singularity", "Final Spark"}, new String[] {"イルミネーション", "ライトバインド", "プリズムバリア", "シンギュラリティ", "ファイナルスパーク"}, SkillDefinition::Lux, false);
    ...
    /** Maokai Definition */
    public static final Champion Maokai = new Champion(57, "Maokai", "マオカイ", "Maokai", 572.2F, 90.0F, 8.675F, 0.85F, 327.28F, 46.0F, 7.205F, 0.45F, 63.544F, 3.3F, 0.694F, 2.125F, 0.0F, 0.0F, 28.72F, 4.0F, 30.0F, 0.0F, 335.0F, 125.0F, new String[] {"Sap Magic", "Arcane Smash", "Twisted Advance", "Sapling Toss", "Vengeful Maelstrom"}, new String[] {"魔樹液", "魔紋打ち", "進撃の樹人", "苗木投げ", "報復の旋風"}, SkillDefinition::Maokai, false);
    ...
    /** Morgana Definition */
    public static final Champion Morgana = new Champion(25, "Morgana", "モルガナ", "Morgana", 547.48F, 86.0F, 5.705F, 0.6F, 340.8F, 60.0F, 6.0F, 0.8F, 55.46F, 3.5F, 0.625F, 1.53F, 0.0F, 0.0F, 25.384F, 3.8F, 30.0F, 0.0F, 335.0F, 450.0F, new String[] {"Soul Siphon", "Dark Binding", "Tormented Soil", "Black Shield", "Soul Shackles"}, new String[] {"魂吸引", "闇の束縛", "苦悶の沼", "漆黒の盾", "魂の足枷"}, SkillDefinition::Morgana, false);

    /** Nami Definition */
    public static final Champion Nami = new Champion(267, "Nami", "ナミ", "Nami", 489.32F, 74.0F, 5.42F, 0.55F, 377.24F, 43.0F, 9.0F, 0.4F, 51.208F, 3.1F, 0.644F, 2.61F, 0.0F, 0.0F, 19.72F, 4.0F, 30.0F, 0.0F, 335.0F, 550.0F, new String[] {"Surging Tides", "Aqua Prison", "Ebb and Flow", "Tidecaller's Blessing", "Tidal Wave"}, new String[] {"激流", "水の監獄", "潮流", "潮使いの祝福", "海神の舞"}, SkillDefinition::Nami, false);

    /** Nasus Definition */
    public static final Champion Nasus = new Champion(75, "Nasus", "ナサス", "Nasus", 561.2F, 90.0F, 9.01F, 0.9F, 275.6F, 45.0F, 7.44F, 0.5F, 59.18F, 3.5F, 0.638F, 3.48F, 0.0F, 0.0F, 24.88F, 3.5F, 32.1F, 1.25F, 350.0F, 125.0F, new String[] {"Soul Eater", "Siphoning Strike", "Wither", "Spirit Fire", "Fury of the Sands"}, new String[] {"魂の統括", "吸魂撃", "風化", "輪廻の炎", "憤怒の熱砂"}, SkillDefinition::Nasus, false);

    /** Nautilus Definition */
    public static final Champion Nautilus = new Champion(111, "Nautilus", "ノーチラス", "Nautilus", 576.48F, 86.0F, 8.37F, 0.55F, 284.0F, 50.0F, 8.625F, 0.7F, 57.544F, 3.3F, 0.613F, 1.0F, 0.0F, 0.0F, 26.46F, 3.75F, 32.1F, 1.25F, 325.0F, 175.0F, new String[] {"Staggering Blow", "Dredge Line", "Titan's Wrath", "Riptide", "Depth Charge"}, new String[] {"鉄の錨", "錨投げ", "大海の激憤", "粉砕水", "爆雷発射"}, SkillDefinition::Nautilus, false);
    ...
    /** Pantheon Definition */
    public static final Champion Pantheon = new Champion(80, "Pantheon", "パンテオン", "Pantheon", 579.16F, 87.0F, 7.84F, 0.65F, 267.12F, 34.0F, 7.355F, 0.45F, 55.572F, 2.9F, 0.644F, 2.95F, 0.0F, 0.0F, 27.652F, 3.9F, 32.1F, 1.25F, 355.0F, 150.0F, new String[] {"Aegis Protection", "Spear Shot", "Aegis of Zeonia", "Heartseeker Strike", "Grand Skyfall"}, new String[] {"イージスの守護", "痛恨の槍", "ゼオニアの加護", "急所乱撃", "天上天下唯我独槍"}, SkillDefinition::Pantheon, false);
    ...
    /** Quinn Definition */
    public static final Champion Quinn = new Champion(133, "Quinn", "クイン", "Quinn", 532.8F, 85.0F, 5.42F, 0.55F, 268.8F, 35.0F, 6.97F, 0.4F, 51.04F, 3.0F, 0.668F, 3.1F, 0.0F, 0.0F, 23.38F, 3.5F, 30.0F, 0.0F, 335.0F, 525.0F, new String[] {"Harrier", "Blinding Assault", "Heightened Senses", "Vault", "Tag Team"}, new String[] {"鷲匠", "暗闇の強襲", "鷹の眼", "飛翔撃", "相棒"}, SkillDefinition::Quinn, false);
    ...
    /** Ryze Definition */
    public static final Champion Ryze = new Champion(13, "Ryze", "ライズ", "Ryze", 558.48F, 86.0F, 5.27F, 0.55F, 342.4F, 55.0F, 5.0F, 1.0F, 55.04F, 3.0F, 0.625F, 2.112F, 0.0F, 0.0F, 21.552F, 3.0F, 30.0F, 0.0F, 340.0F, 550.0F, new String[] {"Arcane Mastery", "Overload", "Rune Prison", "Spell Flux", "Desperate Power"}, new String[] {"古代の呪術", "破呪", "ルーンの牢獄", "呪文跳弾", "禁断の呪力"}, SkillDefinition::Ryze, false);
    ...
    /** Sion Definition */
    public static final Champion Sion = new Champion(14, "Sion", "サイオン", "Sion", 542.64F, 73.0F, 10.18F, 0.8F, 275.6F, 45.0F, 8.005F, 0.6F, 59.72F, 4.0F, 0.679F, 1.3F, 0.0F, 0.0F, 23.04F, 3.0F, 32.1F, 1.25F, 345.0F, 150.0F, new String[] {"Glory in Death", "Decimating Smash", "Soul Furnace", "Roar of the Slayer", "Unstoppable Onslaught"}, new String[] {"名誉ある死", "破滅の斧", "魂の炉心", "殺意の雄叫び", "猪突猛進"}, SkillDefinition::Sion, false);

    /** Sivir Definition */
    public static final Champion Sivir = new Champion(15, "Sivir", "シヴィア", "Sivir", 515.76F, 82.0F, 5.17F, 0.55F, 284.0F, 50.0F, 8.01F, 0.9F, 52.04F, 3.0F, 0.658F, 1.6F, 0.0F, 0.0F, 22.21F, 3.25F, 30.0F, 0.0F, 335.0F, 500.0F, new String[] {"Fleet of Foot", "Boomerang Blade", "Ricochet", "Spell Shield", "On The Hunt"}, new String[] {"戦駆け", "ぶっ放し", "跳刃", "破魔の護り", "狩猟の幕開け"}, SkillDefinition::Sivir, false);
    ...
    /** Sona Definition */
    public static final Champion Sona = new Champion(37, "Sona", "ソナ", "Sona", 482.36F, 77.0F, 5.42F, 0.55F, 340.6F, 45.0F, 9.0F, 0.4F, 50.04F, 3.0F, 0.644F, 2.3F, 0.0F, 0.0F, 20.544F, 3.3F, 30.0F, 0.0F, 325.0F, 550.0F, new String[] {"Power Chord", "Hymn of Valor", "Aria of Perseverance", "Song of Celerity", "Crescendo"}, new String[] {"パワーコード", "ヒム・オブ・ヴァロー", "パーセヴァランス", "セレニティ", "クレッシェンド"}, SkillDefinition::Sona, false);

    /** Soraka Definition */
    public static final Champion Soraka = new Champion(16, "Soraka", "ソラカ", "Soraka", 529.04F, 78.0F, 2.5F, 0.5F, 350.8F, 60.0F, 9.0F, 0.4F, 50.04F, 3.0F, 0.625F, 2.14F, 0.0F, 0.0F, 23.384F, 3.8F, 30.0F, 0.0F, 325.0F, 550.0F, new String[] {"Salvation", "Starcall", "Astral Infusion", "Equinox", "Wish"}, new String[] {"救済", "星のささやき", "星霊の癒し", "星の静寂", "願い"}, SkillDefinition::Soraka, false);

    /** Swain Definition */
    public static final Champion Swain = new Champion(50, "Swain", "スウェイン", "Swain", 516.04F, 78.0F, 7.84F, 0.65F, 324.0F, 50.0F, 6.0F, 0.8F, 52.04F, 3.0F, 0.625F, 2.11F, 0.0F, 0.0F, 22.72F, 4.0F, 30.0F, 0.0F, 335.0F, 500.0F, new String[] {"Carrion Renewal", "Decrepify", "Nevermove", "Torment", "Ravenous Flock"}, new String[] {"屍食再生", "戦慄の怪鳥", "漆黒の束縛", "苦悶", "黒烏の恐襲"}, SkillDefinition::Swain, false);

    /** Syndra Definition */
    public static final Champion Syndra = new Champion(134, "Syndra", "シンドラ", "Syndra", 511.04F, 78.0F, 6.505F, 0.6F, 334.0F, 63.0F, 6.0F, 0.8F, 53.872F, 2.9F, 0.625F, 2.0F, 0.0F, 0.0F, 24.712F, 3.4F, 30.0F, 0.0F, 330.0F, 550.0F, new String[] {"Transcendent", "Dark Sphere", "Force of Will", "Scatter the Weak", "Unleashed Power"}, new String[] {"絶大なる魔力", "闇の魔珠", "魔力の制御", "魔力四散", "魔力解放"}, SkillDefinition::Syndra, false);

    /** Tahm Kench Definition */
    public static final Champion TahmKench = new Champion(223, "Tahm Kench", "タム・ケンチ", "TahmKench", 610.0F, 95.0F, 6.5F, 0.55F, 325.0F, 40.0F, 5.5F, 1.0F, 56.0F, 3.2F, 0.625F, 2.5F, 0.0F, 0.0F, 27.0F, 3.5F, 32.1F, 1.25F, 335.0F, 200.0F, new String[] {"An Acquired Taste", "Tongue Lash", "Devour", "Thick Skin", "Abyssal Voyage"}, new String[] {"味見", "舌のムチ", "丸呑み", "硬質化", "船旅"}, SkillDefinition::TahmKench, false);
    ...
    /** Tristana Definition */
    public static final Champion Tristana = new Champion(18, "Tristana", "トリスターナ", "Tristana", 542.76F, 82.0F, 6.19F, 0.65F, 246.76F, 32.0F, 7.205F, 0.45F, 51.54F, 3.0F, 0.656F, 1.5F, 0.0F, 0.0F, 22.0F, 3.0F, 30.0F, 0.0F, 325.0F, 550.0F, new String[] {"Draw a Bead", "Rapid Fire", "Rocket Jump", "Explosive Charge", "Buster Shot"}, new String[] {"ドロー＆グロー", "ラピッドファイア", "ロケットジャンプ", "ヨードルグレネード", "バスターショット"}, SkillDefinition::Tristana, false);
    ...
    /** Twitch Definition */
    public static final Champion Twitch = new Champion(29, "Twitch", "トゥイッチ", "Twitch", 525.08F, 81.0F, 6.005F, 0.6F, 287.2F, 40.0F, 7.255F, 0.45F, 49.04F, 3.0F, 0.679F, 3.38F, 0.0F, 0.0F, 23.04F, 3.0F, 30.0F, 0.0F, 330.0F, 550.0F, new String[] {"Deadly Venom", "Ambush", "Venom Cask", "Contaminate", "Rat-Ta-Tat-Tat"}, new String[] {"致死毒", "奇襲", "毒瓶投げ", "致死毒活発化", "ラッタッタッタッタ"}, SkillDefinition::Twitch, false);
    ...
    /** Vayne Definition */
    public static final Champion Vayne = new Champion(67, "Vayne", "ヴェイン", "Vayne", 498.44F, 83.0F, 5.42F, 0.55F, 231.8F, 35.0F, 6.97F, 0.4F, 50.46F, 3.25F, 0.658F, 4.0F, 0.0F, 0.0F, 19.012F, 3.4F, 30.0F, 0.0F, 330.0F, 550.0F, new String[] {"Night Hunter", "Tumble", "Silver Bolts", "Condemn", "Final Hour"}, new String[] {"闇夜の狩人　", "転撃", "銀の矢", "制裁", "決戦"}, SkillDefinition::Vayne, false);

    /** Veigar Definition */
    public static final Champion Veigar = new Champion(45, "Veigar", "ヴェイガー", "Veigar", 492.76F, 82.0F, 5.42F, 0.55F, 342.4F, 55.0F, 6.0F, 0.8F, 50.71F, 2.625F, 0.625F, 2.24F, 0.0F, 0.0F, 22.55F, 3.75F, 30.0F, 0.0F, 340.0F, 525.0F, new String[] {"Equilibrium", "Baleful Strike", "Dark Matter", "Event Horizon", "Primordial Burst"}, new String[] {"ワールドバランス", "イーヴィルストライク", "ダークマター", "イベントホライズン", "メテオバースト"}, SkillDefinition::Veigar, false);

    /** Vel'Koz Definition */
    public static final Champion Velkoz = new Champion(161, "Vel'Koz", "ヴェル＝コズ", "Velkoz", 507.68F, 76.0F, 5.42F, 0.55F, 325.6F, 45.0F, 6.0F, 0.8F, 54.937874F, 3.1415927F, 0.625F, 1.36F, 0.0F, 0.0F, 21.88F, 3.5F, 30.0F, 0.0F, 340.0F, 525.0F, new String[] {"Organic Deconstruction", "Plasma Fission", "Void Rift", "Tectonic Disruption", "Life Form Disintegration Ray"}, new String[] {"有機分解", "電離炸裂弾", "ヴォイドの裂谷", "地殻砕裂", "生体破壊光線"}, SkillDefinition::Velkoz, false);
