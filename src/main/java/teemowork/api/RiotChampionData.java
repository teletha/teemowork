...
public class RiotChampionData {
    ...
    /** Graves Definition */
    public static final Champion Graves = new Champion(104, "Graves", "グレイヴズ", "Graves", 551.12F, 84.0F, 6.675F, 0.7F, 322.2F, 40.0F, 7.9F, 0.7F, 60.83F, 2.41F, 0.481F, 2.6F, 0.0F, 0.0F, 24.376F, 3.4F, 30.0F, 0.0F, 340.0F, 425.0F, new String[] {"New Destiny", "End of the Line", "Smoke Screen", "Quickdraw", "Collateral Damage"}, new String[] {"確固たる信念", "End of the Line", "煙幕", "早撃ち", "炸裂砲弾"}, SkillDefinition::Graves, false);
    ...
    /** Poppy Definition */
    public static final Champion Poppy = new Champion(78, "Poppy", "ポッピー", "Poppy", 540.0F, 90.0F, 8.0F, 0.8F, 280.0F, 40.0F, 7.0F, 0.7F, 56.0F, 4.0F, 0.625F, 2.5F, 0.0F, 0.0F, 29.0F, 3.5F, 32.0F, 1.25F, 340.0F, 125.0F, new String[] {"Iron Ambassador", "Hammer Shock", "Steadfast Presence", "Heroic Charge", "Keeper's Verdict"}, new String[] {"勇敢な戦士", "Hammer Shock", "Steadfast Presence", "Heroic Charge", "Keeper's Verdict"}, SkillDefinition::Poppy, false);
    ...
    /** Renekton Definition */
    public static final Champion Renekton = new Champion(58, "Renekton", "レネクトン", "Renekton", 572.16F, 87.0F, 7.96F, 0.75F, 100.0F, 0.0F, 0.0F, 0.0F, 58.328F, 3.1F, 0.665F, 2.65F, 0.0F, 0.0F, 25.584F, 3.8F, 32.1F, 1.25F, 345.0F, 125.0F, new String[] {"Reign of Anger", "Cull the Meek", "Ruthless Predator", "Slice and Dice", "Dominus"}, new String[] {"怒りの支配", "肉削ぎ", "滅多切り", "斬り切り舞", "凶暴化"}, SkillDefinition::Renekton, false);
