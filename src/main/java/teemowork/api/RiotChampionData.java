...
public class RiotChampionData {
    ...
    /** Aatrox Definition */
    public static final Champion Aatrox = new Champion("Aatrox", "エイトロックス", "Aatrox", 537.8F, 85.0F, 6.59F, 0.5F, 105.6F, 45.0F, 0.0F, 0.0F, 60.376F, 3.2F, 0.651F, 3.0F, 0.0F, 0.0F, 24.384F, 3.8F, 32.1F, 0.0F, 345.0F, 150.0F, new String[] {"Blood Well", "Dark Flight", "Blood Thirst / Blood Price", "Blades of Torment", "Massacre"}, new String[] {"血の泉", "闇の翼", "血の渇望/血の代償", "嘆きの刃", "大虐殺"}, SkillDefinition::Aatrox, false);
    ...
    /** Amumu Definition */
    public static final Champion Amumu = new Champion("Amumu", "アムム", "Amumu", 613.12F, 84.0F, 8.875F, 0.85F, 287.2F, 40.0F, 7.38F, 0.525F, 53.384F, 3.8F, 0.638F, 2.18F, 0.0F, 0.0F, 23.544F, 3.3F, 32.1F, 0.0F, 335.0F, 125.0F, new String[] {"Cursed Touch", "Bandage Toss", "Despair", "Tantrum", "Curse of the Sad Mummy"}, new String[] {"呪いの手", "絡みつく包帯", "涙の池", "あばれる", "泣き虫ミイラの呪い"}, SkillDefinition::Amumu, false);
    ...
    /** Diana Definition */
    public static final Champion Diana = new Champion("Diana", "ダイアナ", "Diana", 589.2F, 90.0F, 7.425F, 0.85F, 297.2F, 40.0F, 6.0F, 0.8F, 53.04F, 3.0F, 0.625F, 2.25F, 0.0F, 0.0F, 26.048F, 3.6F, 32.1F, 0.0F, 345.0F, 150.0F, new String[] {"Moonsilver Blade", "Crescent Strike", "Pale Cascade", "Moonfall", "Lunar Rush"}, new String[] {"銀月の刃", "月影", "朧月の羽衣", "瞬月", "月下美刃"}, SkillDefinition::Diana, false);
    ...
    /** Gragas Definition */
    public static final Champion Gragas = new Champion("Gragas", "グラガス", "Gragas", 583.52F, 89.0F, 5.5F, 0.5F, 400.0F, 47.0F, 6.0F, 0.8F, 61.38F, 3.5F, 0.651F, 2.05F, 0.0F, 0.0F, 26.048F, 3.6F, 32.1F, 0.0F, 330.0F, 125.0F, new String[] {"Happy Hour", "Barrel Roll", "Drunken Rage", "Body Slam", "Explosive Cask"}, new String[] {"ふわふわタイム", "タル転がし", "飲みすぎ注意", "腹の肉", "タル爆弾"}, SkillDefinition::Gragas, false);
    ...
    /** Hecarim Definition */
    public static final Champion Hecarim = new Champion("Hecarim", "ヘカリム", "Hecarim", 599.6F, 95.0F, 7.0F, 0.75F, 277.2F, 40.0F, 6.5F, 0.6F, 61.376F, 3.2F, 0.67F, 2.5F, 0.0F, 0.0F, 26.72F, 4.0F, 32.1F, 0.0F, 345.0F, 175.0F, new String[] {"Warpath", "Rampage", "Spirit of Dread", "Devastating Charge", "Onslaught of Shadows"}, new String[] {"出陣", "縦横無尽", "怨霊の恐怖", "猛突進", "幻影の襲撃"}, SkillDefinition::Hecarim, false);
    ...
    /** Irelia Definition */
    public static final Champion Irelia = new Champion("Irelia", "イレリア", "Irelia", 607.2F, 90.0F, 8.59F, 0.65F, 288.8F, 35.0F, 8.09F, 0.65F, 61.544F, 3.3F, 0.665F, 3.2F, 0.0F, 0.0F, 25.3F, 3.75F, 32.1F, 0.0F, 345.0F, 125.0F, new String[] {"Ionian Fervor", "Bladesurge", "Hiten Style", "Equilibrium Strike", "Transcendent Blades"}, new String[] {"アイオニアの熱情", "瞬剣", "飛天流", "平衡の一撃", "飛剣の舞"}, SkillDefinition::Irelia, false);
    ...
    public static final Champion JarvanIV = new Champion("Jarvan IV", "ジャーヴァンⅣ", "JarvanIV", 571.2F, 90.0F, 8.175F, 0.7F, 302.2F, 40.0F, 6.755F, 0.45F, 55.712F, 3.4F, 0.658F, 2.5F, 0.0F, 0.0F, 27.0F, 3.6F, 32.1F, 0.0F, 340.0F, 175.0F, new String[] {"Martial Cadence", "Dragon Strike", "Golden Aegis", "Demacian Standard", "Cataclysm"}, new String[] {"武魂の律動", "龍撃", "黄金の護輪", "デマーシアの旗印", "決戦場"}, SkillDefinition::JarvanIV, false);

    /** Jax Definition */
    public static final Champion Jax = new Champion("Jax", "ジャックス", "Jax", 592.8F, 85.0F, 8.37F, 0.55F, 288.8F, 35.0F, 7.575F, 0.7F, 61.97F, 3.375F, 0.638F, 3.4F, 0.0F, 0.0F, 27.04F, 3.0F, 32.1F, 0.0F, 350.0F, 125.0F, new String[] {"Relentless Assault", "Leap Strike", "Empower", "Counter Strike", "Grandmaster's Might"}, new String[] {"連撃の鬼", "跳躍撃", "入魂", "後の先", "達人の剛力"}, SkillDefinition::Jax, false);
    ...
    /** Kha'Zix Definition */
    public static final Champion Khazix = new Champion("Kha'Zix", "カ＝ジックス", "Khazix", 572.8F, 85.0F, 7.51F, 0.75F, 327.2F, 40.0F, 7.59F, 0.5F, 55.208F, 3.1F, 0.668F, 2.7F, 0.0F, 0.0F, 24.04F, 3.0F, 32.1F, 0.0F, 350.0F, 125.0F, new String[] {"Unseen Threat", "Taste Their Fear", "Void Spike", "Leap", "Void Assault"}, new String[] {"見えざる脅威", "甘美なる恐怖", "破裂の棘", "跳躍", "捕食の本能"}, SkillDefinition::Khazix, false);
    ...
    /** Malphite Definition */
    public static final Champion Malphite = new Champion("Malphite", "マルファイト", "Malphite", 574.2F, 90.0F, 8.37F, 0.55F, 282.2F, 40.0F, 7.32F, 0.55F, 61.97F, 3.375F, 0.638F, 3.4F, 0.0F, 0.0F, 28.3F, 3.75F, 32.1F, 0.0F, 335.0F, 125.0F, new String[] {"Granite Shield", "Seismic Shard", "Brutal Strikes", "Ground Slam", "Unstoppable Force"}, new String[] {"岩盤の盾", "大地の破片", "大地の怒り", "岩強の拳", "不可止の衝撃"}, SkillDefinition::Malphite, false);
    ...
    public static final Champion MasterYi = new Champion("Master Yi", "マスター・イー", "MasterYi", 598.56F, 92.0F, 7.59F, 0.65F, 250.56F, 42.0F, 7.255F, 0.45F, 60.04F, 3.0F, 0.679F, 2.0F, 0.0F, 0.0F, 24.04F, 3.0F, 32.1F, 0.0F, 355.0F, 125.0F, new String[] {"Double Strike", "Alpha Strike", "Meditate", "Wuju Style", "Highlander"}, new String[] {"双連斬", "疾風斬・極", "明鏡止水", "無極流", "無極流奥義"}, SkillDefinition::MasterYi, false);
    ...
    /** Nautilus Definition */
    public static final Champion Nautilus = new Champion("Nautilus", "ノーチラス", "Nautilus", 576.48F, 86.0F, 8.37F, 0.55F, 284.0F, 50.0F, 8.625F, 0.7F, 57.544F, 3.3F, 0.613F, 1.0F, 0.0F, 0.0F, 26.46F, 3.25F, 32.1F, 0.0F, 325.0F, 175.0F, new String[] {"Staggering Blow", "Dredge Line", "Titan's Wrath", "Riptide", "Depth Charge"}, new String[] {"鉄の錨", "錨投げ", "大海の激憤", "粉砕水", "爆雷発射"}, SkillDefinition::Nautilus, false);
    ...
    /** Pantheon Definition */
    public static final Champion Pantheon = new Champion("Pantheon", "パンテオン", "Pantheon", 579.16F, 87.0F, 7.84F, 0.65F, 267.12F, 34.0F, 7.355F, 0.45F, 55.572F, 2.9F, 0.625F, 2.95F, 0.0F, 0.0F, 27.652F, 3.9F, 32.1F, 0.0F, 355.0F, 150.0F, new String[] {"Aegis Protection", "Spear Shot", "Aegis of Zeonia", "Heartseeker Strike", "Grand Skyfall"}, new String[] {"イージスの守護", "痛恨の槍", "ゼオニアの加護", "急所乱撃", "天上天下唯我独槍"}, SkillDefinition::Pantheon, false);
    ...
    /** Rammus Definition */
    public static final Champion Rammus = new Champion("Rammus", "ラムス", "Rammus", 564.48F, 86.0F, 7.92F, 0.55F, 310.44F, 33.0F, 7.84F, 0.5F, 55.88F, 3.5F, 0.625F, 2.215F, 0.0F, 0.0F, 31.384F, 3.8F, 32.1F, 0.0F, 335.0F, 125.0F, new String[] {"Spiked Shell", "Powerball", "Defensive Ball Curl", "Puncturing Taunt", "Tremors"}, new String[] {"トゲトゲ", "ころころ", "大防御", "ちくちく", "ドスンドスン"}, SkillDefinition::Rammus, false);

    /** Rek'Sai Definition */
    public static final Champion RekSai = new Champion("Rek'Sai", "レク＝サイ", "RekSai", 570.0F, 90.0F, 7.34F, 0.65F, 100.0F, 0.0F, 0.0F, 0.0F, 55.628F, 3.35F, 0.625F, 2.0F, 0.0F, 0.0F, 28.3F, 3.75F, 32.1F, 0.0F, 335.0F, 175.0F, new String[] {"Fury of the Xer'Sai", "Queen's Wrath", "Burrow", "Furious Bite", "Void Rush"}, new String[] {"ゼル＝サイの怒り", "女王の怒り", "潜伏", "激情の牙", "ヴォイドの猛攻"}, SkillDefinition::RekSai, false);

    /** Rek'Sai Definition */
    public static final Champion RekSaiTransformed = new Champion("Rek'Sai", "レク＝サイ", "RekSaiTransformed", 570.0F, 90.0F, 7.34F, 0.65F, 100.0F, 0.0F, 0.0F, 0.0F, 55.628F, 3.35F, 0.0F, 0.625F, 0.0F, 0.0F, 28.3F, 3.75F, 32.1F, 0.0F, 335.0F, 175.0F, new String[] {"Fury of the Xer'Sai", "Prey Seeker", "Un-burrow", "Tunnel", "Void Rush"}, new String[] {"ゼル＝サイの怒り", "獲物定め", "襲撃", "掘削", "ヴォイドの猛攻"}, SkillDefinition::RekSaiTransformed, true);

    /** Renekton Definition */
    public static final Champion Renekton = new Champion("Renekton", "レネクトン", "Renekton", 572.16F, 87.0F, 7.96F, 0.75F, 100.0F, 0.0F, 0.0F, 0.0F, 58.328F, 3.1F, 0.665F, 2.65F, 0.0F, 0.0F, 25.584F, 3.8F, 32.1F, 0.0F, 345.0F, 125.0F, new String[] {"Reign of Anger", "Cull the Meek", "Ruthless Predator", "Slice and Dice", "Dominus"}, new String[] {"怒りの支配", "肉削ぎ", "無慈悲な連撃", "斬り切り舞", "凶暴化"}, SkillDefinition::Renekton, false);
    ...
    /** Sejuani Definition */
    public static final Champion Sejuani = new Champion("Sejuani", "セジュアニ", "Sejuani", 600.0F, 95.0F, 8.675F, 0.85F, 400.0F, 40.0F, 7.205F, 0.45F, 57.544F, 3.3F, 0.67F, 1.44F, 0.0F, 0.0F, 29.54F, 3.0F, 32.1F, 0.0F, 340.0F, 125.0F, new String[] {"Frost", "Arctic Assault", "Flail of the Northern Winds", "Permafrost", "Glacial Prison"}, new String[] {"凍傷", "猪突凍進", "北風のフレイル", "永久凍土", "氷河の牢獄"}, SkillDefinition::Sejuani, false);
    ...
    /** Shen Definition */
    public static final Champion Shen = new Champion("Shen", "シェン", "Shen", 570.8F, 85.0F, 8.37F, 0.55F, 200.0F, 0.0F, 50.0F, 0.0F, 60.17F, 3.375F, 0.651F, 3.4F, 0.0F, 0.0F, 25.72F, 4.0F, 32.1F, 0.0F, 335.0F, 125.0F, new String[] {"Ki Strike", "Vorpal Blade", "Feint", "Shadow Dash", "Stand United"}, new String[] {"気功斬", "吸命刀", "護遁の術", "殺気駆け", "刹那護法"}, SkillDefinition::Shen, false);

    /** Shyvana Definition */
    public static final Champion Shyvana = new Champion("Shyvana", "シヴァーナ", "Shyvana", 594.6F, 95.0F, 8.59F, 0.8F, 100.0F, 0.0F, 0.0F, 0.0F, 60.712F, 3.4F, 0.658F, 2.5F, 0.0F, 0.0F, 27.628F, 3.35F, 32.1F, 0.0F, 350.0F, 125.0F, new String[] {"Dragonborn", "Twin Bite", "Burnout", "Flame Breath", "Dragon's Descent"}, new String[] {"龍族の血脈", "双咬撃", "烈風炎", "火炎の息吹", "龍族の血統"}, SkillDefinition::Shyvana, false);
    ...
    /** Sion Definition */
    public static final Champion Sion = new Champion("Sion", "サイオン", "Sion", 542.64F, 73.0F, 10.18F, 0.8F, 275.6F, 45.0F, 8.005F, 0.6F, 59.72F, 4.0F, 0.679F, 1.3F, 0.0F, 0.0F, 23.04F, 3.0F, 32.1F, 0.0F, 345.0F, 150.0F, new String[] {"Glory in Death", "Decimating Smash", "Soul Furnace", "Roar of the Slayer", "Unstoppable Onslaught"}, new String[] {"名誉ある死", "破滅の斧", "魂の炉心", "殺意の雄叫び", "猪突猛進"}, SkillDefinition::Sion, false);
    ...
    public static final Champion TahmKench = new Champion("Tahm Kench", "タム・ケンチ", "TahmKench", 610.0F, 95.0F, 6.5F, 0.55F, 325.0F, 40.0F, 5.5F, 1.0F, 56.0F, 3.2F, 0.625F, 2.5F, 0.0F, 0.0F, 27.0F, 3.0F, 32.1F, 0.0F, 335.0F, 200.0F, new String[] {"An Acquired Taste", "Tongue Lash", "Devour", "Thick Skin", "Abyssal Voyage"}, new String[] {"味見", "舌のムチ", "丸呑み", "硬質化", "船旅"}, SkillDefinition::TahmKench, false);
    ...
    /** Taric Definition */
    public static final Champion Taric = new Champion("Taric", "タリック", "Taric", 619.2F, 90.0F, 7.94F, 0.5F, 349.08F, 56.0F, 6.0F, 0.8F, 57.88F, 3.5F, 0.625F, 2.02F, 0.0F, 0.0F, 25.876F, 3.2F, 32.1F, 0.0F, 340.0F, 125.0F, new String[] {"Gemcraft", "Imbue", "Shatter", "Dazzle", "Radiance"}, new String[] {"ジェムクラフト", "パワーストーン", "ジェムクラッシュ", "プリズムチャーム", "シャイニング"}, SkillDefinition::Taric, false);
    ...
    /** Trundle Definition */
    public static final Champion Trundle = new Champion("Trundle", "トランドル", "Trundle", 616.28F, 96.0F, 9.425F, 0.85F, 281.6F, 45.0F, 7.505F, 0.6F, 60.04F, 3.0F, 0.67F, 2.9F, 0.0F, 0.0F, 27.536F, 2.7F, 32.1F, 0.0F, 350.0F, 125.0F, new String[] {"King's Tribute", "Chomp", "Frozen Domain", "Pillar of Ice", "Subjugate"}, new String[] {"王への貢物", "噛み付き", "凍てつく大地", "氷冷の柱", "暴虐なる搾取"}, SkillDefinition::Trundle, false);

    /** Tryndamere Definition */
    public static final Champion Tryndamere = new Champion("Tryndamere", "トリンダメア", "Tryndamere", 625.64F, 98.0F, 8.51F, 0.9F, 100.0F, 0.0F, 0.0F, 0.0F, 61.376F, 3.2F, 0.67F, 2.9F, 0.0F, 0.0F, 24.108F, 3.1F, 32.1F, 0.0F, 345.0F, 125.0F, new String[] {"Battle Fury", "Bloodlust", "Mocking Shout", "Spinning Slash", "Undying Rage"}, new String[] {"戦場の咆哮", "血の欲望", "嘲りの叫び", "旋回斬り", "不死の憤激"}, SkillDefinition::Tryndamere, false);
    ...
    /** Udyr Definition */
    public static final Champion Udyr = new Champion("Udyr", "ウディア", "Udyr", 593.32F, 99.0F, 8.71F, 0.75F, 270.4F, 30.0F, 7.505F, 0.45F, 58.286F, 3.2F, 0.658F, 2.67F, 0.0F, 0.0F, 25.47F, 4.0F, 32.1F, 0.0F, 345.0F, 125.0F, new String[] {"Monkey's Agility", "Tiger Stance", "Turtle Stance", "Bear Stance", "Phoenix Stance"}, new String[] {"乱撃高揚", "虎形態", "亀形態", "熊形態", "不死鳥形態"}, SkillDefinition::Udyr, false);
    ...
    /** Yorick Definition */
    public static final Champion Yorick = new Champion("Yorick", "ヨーリック", "Yorick", 563.8F, 85.0F, 8.175F, 0.7F, 293.8F, 35.0F, 6.755F, 0.45F, 57.58F, 3.5F, 0.625F, 3.0F, 0.0F, 0.0F, 25.048F, 3.6F, 32.1F, 0.0F, 345.0F, 125.0F, new String[] {"Unholy Covenant", "Omen of War", "Omen of Pestilence", "Omen of Famine", "Omen of Death"}, new String[] {"不浄な誓約", "戦の凶兆", "疫の凶兆", "飢の凶兆", "死の凶兆"}, SkillDefinition::Yorick, false);
