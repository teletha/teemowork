...
public class Item extends Describable<ItemDescriptor> {
    ...
    public static final Item BerserkersGreaves = new Item(3006, "Berserker's Greaves", item -> {
        item.build(Item.BootsOfSpeed, Item.Dagger)
                .cost(150)
                .attackSpeed(20)
    ...
    public static final Item Bloodthirster = new Item(3072, "The Bloodthirster", item -> {
        item.build(BFSword, Item.VampiricScepter).cost(850).lifeSteal(12).attackDamage(70).add(ability -> {
            ability.ununique()
    ...
    public static final Item BonetoothNecklace = new Item(3166, "Bonetooth Necklace", item -> {
        item.cost(800).attackDamage(5).add(ability -> {
    ...
    public static final Item Brutalizer = new Item(3134, "The Brutalizer", item -> {
        item.build(LongSword, LongSword)
                .cost(547)
                .attackDamage(25)
                .add(ability -> {
    ...
    public static final Item DoransBlade = new Item(1055, "Doran's Blade", item -> {
        item.cost(475)
                ...
                .add(ability -> {
            ability.ununique()
                    .passive("敵ユニットに対して通常攻撃をする毎に{1}する。")
                    .variable(1, RestoreHealth, 5)
    ...
    public static final Item DoransRing = new Item(1056, "Doran's Ring", item -> {
        item.cost(475)
            ...
            ability.ununique()
                    ...
                    .variable(1, RestoreMana, 5)

            .update(P308)
                    .variable(1, RestoreMana, 4);
        } )
    ...
    public static final Item DoransShield = new Item(1054, "Doran's Shield", item -> {
        item.cost(475)
                ...
                .armor(5)
                .add(ability -> {
            ability.passive("敵Championからの{1}する。")
                    .variable(1, AttackDamageReduction, 6)

            .update(P308)
                    .variable(1, AttackDamageReduction, 8);
        } )
    ...
    public static final Item EmblemOfValor = new Item(3097, "Emblem of Valor", item -> {
        item.build(ClothArmor, RejuvenationBead)
                .cost(170)
                .armor(20)
                .add(Ability.Valor)
    ...
    public static final Item ExecutionersCalling = new Item(3123, "Executioner's Calling", item -> {
        item.build(AvariceBlade, Item.LongSword)
                .cost(700)
                .attackDamage(25)
                .critical(20)
                .add(ability -> {
    ...
    public static final Item FrozenMallet = new Item(3022, "Frozen Mallet", item -> {
        item.build(Item.Phage, Item.GiantsBelt)
                .cost(835)
                .attackDamage(30)
                .health(700)
                .add(Ability.Icy2)
        ...
        .update(P310A)
                .build(Item.GiantsBelt, Item.Pickaxe, Item.RubyCrystal)
                .cost(950)
    ...
    public static final Item GuinsoosRageblade = new Item(3124, "Guinsoo's Rageblade", item -> {
        item.build(BlastingWand, Item.Pickaxe).cost(865).attackDamage(30).abilityPower(40).add(ability -> {
            ability.ununique()
    ...
    public static final Item HauntingGuise = new Item(3136, "Haunting Guise", item -> {
        item.build(Item.RubyCrystal, AmplifyingTome)
                .cost(575)
                .abilityPower(25)
                .health(200)
    ...
    public static final Item LastWhisper = new Item(3035, "Last Whisper", item -> {
        item.build(Item.LongSword, Item.Pickaxe)
                .cost(1025)
                .attackDamage(40)
    ...
    public static final Item MadredsRazors = new Item(3106, "Madred's Razors", item -> {
        item.build(ClothArmor, HuntersMachete)
                .price(100, 490)
                .armor(25)
                .add(Ability.Maim)
                .add(Ability.Rend)
    ...
    public static final Item ManaManipulator = new Item(3037, "Mana Manipulator", item -> {
        item.build(FaerieCharm, FaerieCharm)
                .cost(40)
    ...
    public static final Item OraclesElixir = new Item(2042, "Oracle's Elixir", item -> {
        item.cost(400)
                .add(Ability.OraclesElixirActive)
    ...
    public static final Item Phage = new Item(3044, "Phage", item -> {
        item.build(RubyCrystal, LongSword)
                .cost(590)
                .attackDamage(20)
                .health(200)
                .add(Ability.Icy1)
    ...
    public static final Item PhilosophersStone = new Item(3096, "Philosopher's Stone", item -> {
        item.build(FaerieCharm, RejuvenationBead)
                .cost(340)
                .manaRegen(9)
                .healthRegen(7)
                .add(Ability.Transmute)
    ...
    public static final Item Thornmail = new Item(3075, "Thornmail", item -> {
        item.build(ChainVest, ClothArmor).cost(1180).armor(100).add(ability -> {
    ...
    public static final Item WardensMail = new Item(3082, "Warden's Mail", item -> {
        item.build(ClothArmor, ClothArmor)
                .cost(500)
                .armor(50)
