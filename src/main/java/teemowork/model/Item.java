...
public class Item extends Describable<ItemDescriptor> {
    ...
    /** Amplifying Tome */
    public static final Item AmplifyingTome = new Item(RiotItemData.AmplifyingTome);
    ...
    /** B. F. Sword */
    public static final Item BFSword = new Item(RiotItemData.BFSword);
    ...
    /** Blasting Wand */
    public static final Item BlastingWand = new Item(RiotItemData.BlastingWand);
    ...
    /** Brawler's Gloves */
    public static final Item BrawlersGloves = new Item(RiotItemData.BrawlersGloves);
    ...
    /** Chain Vest */
    public static final Item ChainVest = new Item(RiotItemData.ChainVest);
    ...
    /** Cloak of Agility */
    public static final Item CloakOfAgility = new Item(RiotItemData.CloakofAgility);

    /** Cloth Armor */
    public static final Item ClothArmor = new Item(RiotItemData.ClothArmor);
    ...
    /** Dagger */
    public static final Item Dagger = new Item(RiotItemData.Dagger);
    ...
    /** Doran's Blade */
    public static final Item DoransBlade = new Item(RiotItemData.DoransBlade);
    ...
    /** Long Sword */
    public static final Item LongSword = new Item(RiotItemData.LongSword);

    /** Item */
    public static final Item LostChapter = new Item(RiotItemData.LostChapter, item -> {
        item.add(ability -> {
    ...
    public static final Item NeedlesslyLargeRod = new Item(RiotItemData.NeedlesslyLargeRod);

    /** Negatron Cloak */
    public static final Item NegatronCloak = new Item(RiotItemData.NegatronCloak);
    ...
    /** Null-Magic Mantle */
    public static final Item NullMagicMantle = new Item(RiotItemData.NullMagicMantle);
    ...
    /** Pickaxe */
    public static final Item Pickaxe = new Item(RiotItemData.Pickaxe);
    ...
    /** Sapphire Crystal */
    public static final Item SapphireCrystal = new Item(RiotItemData.SapphireCrystal);
    ...
    /** Vampiric Scepter */
    public static final Item VampiricScepter = new Item(RiotItemData.VampiricScepter);
    ...
    /** Zeal */
    public static final Item Zeal = new Item(RiotItemData.Zeal);
    ...
    Item(RiotItemData data, Consumer<ItemDescriptor> descriptor) {
        ...
        this.descriptor = item -> {
            if (descriptor != null) {
                descriptor.accept(item);
            }

            item.health(data.health)
                    .healthRegen(data.flatHealthRegen)
                    .mana(data.mana)
                    .ad(data.ad)
                    .ar(data.ar)
                    .ap(data.ap)
