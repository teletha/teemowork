...
public class Skill extends Describable<SkillDescriptor> {
    ...
    private static void MissFortune() {
    ...
    private static void MonkeyKing() {
        MonkeyKing.P.update()
    ...
    private static void Mordekaiser() {
    ...
    private static void TwistedFate() {
