...
public class ChampionSelect extends Widget {
    ...
    private final FilterGroup[] groups = {
            ...
            new FilterGroup("Buff",
                    ...
                    type(Status.ARPen, Status.ARPenRatio, Status.ARReduction, Status.ARReductionRatio),
                    type(Status.MRPen, Status.MRPenRatio, Status.MRReduction, Status.MRReductionRatio),
